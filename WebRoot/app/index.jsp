	...
	<div class="index_all" style="text-align: center;">
		...
		<div id="index_center">
			...
			<div>
				...
				<!--菜单层的中间-->
				<div class="bg_middle">
					<img src="${pageContext.request.contextPath}/app/detail/style/images/index_menu.gif" border="0" usemap="#Map" />
					<map name="Map" id="Map">
			...
			<div id="center_bottom">
				<ul style="display: inline-table">
					<c:forEach var="dinnerTable" items="${listFree}">
						<li><a href="${pageContext.request.contextPath}/FrontListServlet?method=listfood&tableId=${dinnerTable.id}">${dinnerTable.tableName}</a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
