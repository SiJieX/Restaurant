		...
		<div id="menu1">
			...
			<div class="menu3">
				<div class="menu3_left">
					<img src="style/images/baizhuoxia.jpg" style="width: 270px; height: 290px;" />
				</div>
			...
			<div class="menu4">
				...
				<a href="clientCart.jsp" style="background: url(style/images/img/order_left_corner_bg.png);">放入餐车</a> <a href="#" onclick="javascript:history.go(-1);"
