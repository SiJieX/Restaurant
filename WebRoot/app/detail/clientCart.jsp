			...
			<div id="count">
				<table align="center" width="100%">
					...
					<tr height="60">
						...
						<td align="center" width="20%"><input type="text" value="1" size="3" lang="3" onblur="alterSorder(this)" /></td>
						<td align="center" width="20%">68.0</td>
						<td align="center" width="20%"><input type="button" value="删除" class="btn_next" lang="3" onclick="removeSorder(this)" /></td>
					</tr>

					<tr>
						<td colspan="6" align="right">总计: <span style="font-size: 36px;">&yen;&nbsp;68.0</span> <label id="counter" style="font-size: 36px"></label>
						</td>
					</tr>
					<tr>
						<td colspan="6" style="margin-left: 100px; text-align: center;" align="right"><input type="hidden" name="bId" value=""> <input type="button" value="下单" class="btn_next"
		...
		<div id="dish_class">
			<div id="dish_top">
				<ul>
					...
					<li><a href="clientOrderList.jsp"> <img src="style/images/call2.gif" />
					</a></li>
				</ul>
			</div>
			...
			<div id="dish_2">
				<ul>
					...
					<li><a href="caidan.jsp">粤菜</a></li>

					<li><a href="chuancai.jsp">川菜</a></li>

					<li><a href="chuancai.jsp">湘菜</a></li>

					<li><a href="chuancai.jsp">东北菜</a></li>
