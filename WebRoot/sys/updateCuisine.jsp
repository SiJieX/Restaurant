...
<body>
	...
	<div id="MainArea">
		<!-- 表单内容 -->
		<form action="${pageContext.request.contextPath }/DishesServlet" method="post">
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								...
								<td><input type="text" name="dishesName" class="InputStyle" value="${requestScope.dishesName }" /> * <input type="hidden" name="id" value="${requestScope.id}" /> <input type="hidden"
									name="method" value="update" /></td>
							</tr>
						</table>
					</div>
				</div>
